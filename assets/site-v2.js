(function(){
  ...
  function ensureSecondaryV2(){if(secondaryPaths.indexOf(path)===-1)return;if(!document.querySelector('link[href*="secondary-v2.css"]')){var style=document.createElement('link');style.rel='stylesheet';style.href='/secondary-v2.css?v=20260828-1';document.head.appendChild(style);}if(!document.querySelector('script[src*="secondary-v2.js"]')){var script=document.createElement('script');script.defer=true;script.src='/assets/secondary-v2.js?v=20260828-1';document.body.appendChild(script);}}
  ensureGlobalStyle();
  ensureSecondaryV2();
