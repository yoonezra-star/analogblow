(function(){
  ...
  var groups=[
    ...
    {key:'weekend',label:'주말·외식',match:['/culture-leisure','/weekend','/cafes','/restaurants'],items:[['/culture-leisure','주말·외식 전체'],['/weekend','가족 나들이'],['/kids-play','키즈·실내놀이'],['/cafes','카페'],['/restaurants','운정 상권 가이드']]},
    {key:'neighborhoods',label:'생활권',match:['/neighborhoods','/unjeong-intro'],items:[['/neighborhoods','생활권 전체'],['/unjeong-intro','운정 소개'],['/posts/unjeong-station-life-guide','운정역 생활권'],['/posts/yadang-station-life-guide','야당역 생활권'],['/posts/gyoha-dongpae-life-guide','교하·동패 생활권']]},
